...
console.log("multidiv: ",multiplyThenDivide(bango3, bango4, bango5));

function multiplyThenDivide(num1,num2, num3){
	return divide(multiply(num1,num2), num3);

}
console.log("multidiv2: ", multiplyThenDivide(bango3, bango4, bango5))
...
return firstName + lastName;
 ...
 var myFullName = createFullName("Bradley"," Foster");
...
console.log(eatFood("Bradley ", "Foster", "eggs "))
